...
def parse_args():
    ...
    parser.add_argument('--loss_fn', default='MAE', type=str)
    ...
    parser.add_argument('--file_list_fn', default='/mnt/minerl/frames/file_list.pth', type=str)
    parser.add_argument('--image_dir_path', default='/mnt/minerl/frames/**/*', type=str)
    parser.add_argument('--image_fn_regex', default='.*\.png$', type=str)
    parser.add_argument('--checkpoint_interval', default=2500, type=int)
    parser.add_argument('--latent_loss_weight', default=0.005, type=float)
    ...
    parser.add_argument('--project', default='mcvq', type=str, help='project name for wandb')
    parser.add_argument('--name', default='mcvq_' + uuid.uuid4().hex, type=str, help='wandb experiment name')
